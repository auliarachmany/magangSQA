...
public class HalamanPerjalananDinas {

    private final WebDriver driver;

    public HalamanPerjalananDinas() {
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div[1]/div[2]/div/div/div[1]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div/div/div[9]/div[2]/p")
    WebElement perjalananDinas;

    @FindBy(xpath = "/html/body/div[1]/div/header/div/p")
    WebElement txtHeadingPerjalananDinas;
    ...
    @FindBy (xpath = "/html/body/div[10]/div[3]/div/form/div[2]/button[2]")
    ...
    @FindBy (xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div[1]/div/table/tbody/tr[2]/td[7]/div/div/button")
    WebElement MenuApprove;

    @FindBy (xpath = "/html/body/div[4]/div[3]/ul/li[1]")
    WebElement ApprovePerjalananDinas;

    @FindBy (xpath = "/html/body/div[10]/div[3]/div/form/div[2]/button[1]")
    WebElement btnYa;

    @FindBy (xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div[1]/div/table/tbody/tr[2]/td[6]/div/h6")
    WebElement txtStatus;

    @FindBy(xpath = "/html/body/div[10]/div[3]/div/form/div[2]/button[2]")
    WebElement btnTidakApproved;

    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div[1]/div/table/tbody/tr[1]/td[7]/div/div/button")
    WebElement menuReject;
    @FindBy(xpath = "/html/body/div[3]/div[3]/ul/li[2]")
    WebElement rejectPerjalananDinas;

    @FindBy(id = "rejectReason")
    WebElement inputAlasan;

    @FindBy(xpath = "/html/body/div[10]/div[3]/div/form/div[2]/button[1]")
    WebElement btnYaReject;

    @FindBy(xpath = "/html/body/div[10]/div[3]/div/form/div[2]/button[2]")
    WebElement btnTidakReject;

    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div[1]/div/table/tbody/tr[1]/td[6]/div/h6")
    WebElement txtStatusReject;

    @FindBy(id = "mui-5")
    WebElement rowPerPage;

    @FindBy(xpath = "/html/body/div[10]/div[3]/ul/li[1]")
    WebElement page5;

    @FindBy(xpath = "/html/body/div[10]/div[3]/ul/li[2]")
    WebElement page10;

    @FindBy(xpath = "/html/body/div[10]/div[3]/ul/li[3]")
    WebElement page25;
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div[1]/div/table/tbody/tr[2]/td[5]/h6/a/button")
    WebElement btnView;

    @FindBy(xpath = "/html/body/main/h1")
    WebElement txt404View;

    public void BtnLaporan() {
        Laporan.click();
    }
    public void BtnPerjalananDinas() {
        perjalananDinas.click();
    }

    public String getTxtHeadingPerjalananDinas() {
        return txtHeadingPerjalananDinas.getText();
    }
    ...
    public void setApprovePerjalananDinas () {
        ApprovePerjalananDinas.click();
    }
    ...
    public void btnTidakAprroved() {
        btnTidakApproved.click();
    }

    public void setRejectPerjalananDinas() {
        rejectPerjalananDinas.click();
    }
    ...
    public void btnYaReject() {
        btnYaReject.click();
    }

    public void btnTidakReject() {
        btnTidakReject.click();
    }

    public void menuReject() {
        menuReject.click();
    }
    ...
    public String getTxt404View() {
        return txt404View.getText();
    }
    ...
    public String gettxtStatusReject() {
        return txtStatusReject.getText();
    }
