...
public class HalamanLaporanLembur {
    private final WebDriver driver;

    public HalamanLaporanLembur() {
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div[1]/div[2]/div/div/div[1]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div[2]/div/div/div/div[8]/div[2]/p")
    WebElement LaporanLembur;
    @FindBy(xpath = "/html/body/div[1]/div/header/div/p")
    WebElement txtHeadingLembur;
    @FindBy(id = "search")
    WebElement inputsearch;

    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[1]/div/table/tbody/tr[1]/td[2]/h6")
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div/div/p[2]")
    ...
    @FindBy(xpath = "/html/body/div[13]/div[3]/div/form/div[1]")
    WebElement Test;
    ...
    @FindBy (xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[1]/div/table/tbody/tr[1]/td[10]/div/div/button")
    WebElement MenuApprove;

    @FindBy (xpath = "/html/body/div[3]/div[3]/ul/li[1]")
    WebElement Approvelembur;

    @FindBy (xpath = "/html/body/div[13]/div[3]/div/form/div[2]/button[1]")
    WebElement Setujui;

    @FindBy (xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[1]/div/table/tbody/tr[1]/td[9]/div/h6")
    ...
    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div/div/div[3]/button[2]")
    WebElement btnPreviousPage;

    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div/div/div[3]/button[4]")
    WebElement btnLastPage;

    @FindBy(xpath = "/html/body/div[1]/div/div[2]/div/div[1]/div/div[2]/div/div[2]/div/div/div[3]/button[1]")
    ...
    public void setApprovelembur () {
        Approvelembur.click();
    }

    public void setSetujui () {
        Setujui.click();
    }
    ...
    public void btnTolak() {
        btnTolak.click();
    }

    public void btnTidakTolak() {
        btnTidakTolak.click();
    }
    ...
    public String getTxtHeadingLembur() {
        return txtHeadingLembur.getText();
    }
